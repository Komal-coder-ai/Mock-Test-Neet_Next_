          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <div className="muted text-sm mt-1">
                {paper
                  ? `${paper.durationMinutes} mins • ${paper.totalQuestions} questions`
                  : ""}
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="p-4 border rounded">
              ...
              <ol className="list-decimal list-inside mt-2 text-sm muted space-y-1">
                <li>
                  The test contains 60 multiple choice questions across Physics,
            ...
            <div className="p-4 border rounded">
              ...
              <div className="mt-3 flex gap-3">
                <div className="flex-1 p-3 bg-green-50 border rounded text-green-700">
                  Correct Answer: +4 marks
                </div>
                <div className="flex-1 p-3 bg-red-50 border rounded text-red-600">
                  Wrong Answer: -1 mark
                </div>
                <div className="flex-1 p-3 bg-gray-50 border rounded text-gray-600">
